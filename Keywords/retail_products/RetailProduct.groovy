...
class RetailProduct {
	@Keyword
	def RetailProducts() {
		if(WebUI.verifyElementText(findTestObject('Trend Page/FS and Retail Products/Retail Products/Page_AI Palette/h3_Related Retail Products'),
		'Related Retail Products', true)) {
