...
class FoodService {
	...
	@Keyword
	def FoodServiceProducts() {
		if(WebUI.verifyElementText(findTestObject('Trend Page/FS and Retail Products/Food Service/Page_AI Palette/h3_Food Service Products'),
		'Food Service Products', true)) {
