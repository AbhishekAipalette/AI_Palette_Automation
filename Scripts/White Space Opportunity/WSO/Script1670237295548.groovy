...
WebUI.takeScreenshot('Documents/WSO_Ingredient.png')
...
WebUI.takeScreenshot('Documents/WSO_Ingredient_Graph.png')

WebUI.click(findTestObject('Object Repository/WSO/Page_AI Palette/button_Table View'))

WebUI.takeScreenshot('Documents/WSO_Ingredient_Table.png')
...
WebUI.takeScreenshot('Documents/WSO_Theme_Graph.png')

WebUI.click(findTestObject('Object Repository/WSO/Page_AI Palette/button_Table View'))

WebUI.takeScreenshot('Documents/WSO_Theme_Table.png')
