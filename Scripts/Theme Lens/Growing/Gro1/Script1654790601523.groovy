...
WebUI.click(findTestObject('Theme Lens/Theme Maturity Phase/Page_AI Palette/Gro(img1)'))
...
WebUI.callTestCase(findTestCase('Theme Lens/Growing/Gro2'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Theme Lens/Growing/Gro3'), [:], FailureHandling.CONTINUE_ON_FAILURE)
