...
WebUI.callTestCase(findTestCase('Theme Lens/Matured/Mat2'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Theme Lens/Matured/Mat3'), [:], FailureHandling.CONTINUE_ON_FAILURE)
