...
WebUI.setText(findTestObject('Object Repository/Trend Pillar/Page_AI Palette/input_Pillar Name_PillarName'), GlobalVariable.pillarTheme)
...
WebUI.takeScreenshot('Documents/pillarTheme.png')
...
WebUI.takeScreenshot('Documents/pillarTheme1.png')
