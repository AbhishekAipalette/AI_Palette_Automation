...
WebUI.setText(findTestObject('Object Repository/Trend Pillar/Page_AI Palette/input_Pillar Name_PillarName'), GlobalVariable.pillarIngredient)
...
WebUI.takeScreenshot('Documents/pillarIngredient.png')
