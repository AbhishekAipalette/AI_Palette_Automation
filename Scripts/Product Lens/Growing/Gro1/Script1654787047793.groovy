...
WebUI.click(findTestObject('Product Lens/Prod Maturity Phase/Page_AI Palette/span_Growing'))

WebUI.click(findTestObject('Product Lens/Prod Maturity Phase/Page_AI Palette/Grow(img1)'))
...
WebUI.callTestCase(findTestCase('Product Lens/Growing/Gro2'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Product Lens/Growing/Gro3'), [:], FailureHandling.CONTINUE_ON_FAILURE)
