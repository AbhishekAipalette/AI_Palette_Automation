...
WebUI.click(findTestObject('Product Lens/Prod Maturity Phase/Page_AI Palette/span_Emerging'))

WebUI.click(findTestObject('Product Lens/Prod Maturity Phase/Page_AI Palette/Em(img1)'))
...
WebUI.callTestCase(findTestCase('Product Lens/Trend Page'), [:], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('Product Lens/Trend CN'), [:], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('Product Lens/Trend SCN'), [:], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForPageLoad(10)

WebUI.callTestCase(findTestCase('Product Lens/Emerging/Eme2'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Product Lens/Emerging/Eme3'), [:], FailureHandling.CONTINUE_ON_FAILURE)
