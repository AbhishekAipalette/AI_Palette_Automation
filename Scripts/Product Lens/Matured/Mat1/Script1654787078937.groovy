...
WebUI.click(findTestObject('Product Lens/Prod Maturity Phase/Page_AI Palette/Mat(img1)'))
...
WebUI.callTestCase(findTestCase('Product Lens/Matured/Mat2'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Product Lens/Matured/Mat3'), [:], FailureHandling.CONTINUE_ON_FAILURE)
