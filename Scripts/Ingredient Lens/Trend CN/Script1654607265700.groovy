...
if (WebUI.verifyTextPresent('Consumer Insights', true)) {
...
*/
    WebUI.verifyElementText(findTestObject('Trend Page/Trend Page Consumer Insights/Trend CN/Page_AI Palette/h6_Driver'), 
        'Driver')
    ...
    WebUI.verifyElementPresent(findTestObject('Trend Page/Trend Page Consumer Insights/Trend CN/Page_AI Palette/span_4 year CAGR'), 
        0)

    WebUI.verifyElementText(findTestObject('Trend Page/Trend Page Consumer Insights/Trend CN/Page_AI Palette/h3_Volume'), 
        'Volume')

    WebUI.executeJavaScript('window.scrollTo(5000, 80)', null)

    WebUI.verifyElementText(findTestObject('Trend Page/Trend Page Consumer Insights/Trend CN/Page_AI Palette/h3_Driver'), 
        'Driver')

    WebUI.verifyElementText(findTestObject('Trend Page/Trend Page Consumer Insights/Trend CN/Page_AI Palette/h3_Verbatims'), 
        'Verbatims')

    WebUI.verifyElementText(findTestObject('Trend Page/Trend Page Consumer Insights/Trend CN/Page_AI Palette/h3_Topics'), 
        'Topics')
} else {
    System.out.println('Trend Consumer Insights are missing')
}
