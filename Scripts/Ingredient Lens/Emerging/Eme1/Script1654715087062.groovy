...
WebUI.click(findTestObject('Ingrdient Lens/Ing Maturity Phase/Page_AI Palette/Em(img1)'))
...
WebUI.callTestCase(findTestCase('Ingredient Lens/Emerging/Eme2'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Ingredient Lens/Emerging/Eme3'), [:], FailureHandling.CONTINUE_ON_FAILURE)
