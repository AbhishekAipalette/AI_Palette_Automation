...
WebUI.click(findTestObject('Ingrdient Lens/Ing Maturity Phase/Page_AI Palette/Mat(img1)'))
...
WebUI.callTestCase(findTestCase('Ingredient Lens/Matured/Mat2'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Ingredient Lens/Matured/Mat3'), [:], FailureHandling.CONTINUE_ON_FAILURE)
