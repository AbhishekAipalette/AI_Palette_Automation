...
WebUI.click(findTestObject('Ingrdient Lens/Ing Sub Category/Page_AI Palette/Page_AI Palette/span_Ingredient'))
...
WebUI.click(findTestObject('Ingrdient Lens/Ing Sub Category/Page_AI Palette/button_Reset All Filters'))
